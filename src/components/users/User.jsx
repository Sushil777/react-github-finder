...
const User = ({ match }) => {
  ...
  return <Fragment>
    ...
    Hireable: {hireable ? <i className='fas fa-check text-success'></i> : <i className='fa fa-times-circle text-danger'></i>}
    ...
    <div className='card text-center'>
      ...
      <div className='badge badge-whites'>Public Repos: {public_repos}</div>
